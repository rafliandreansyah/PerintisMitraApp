 ...
 * Use the [RegisterPartnerInfoFragment.newInstance] factory method to
...
class RegisterPartnerInfoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterPartnerInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegisterPartnerInfoFragment().apply {
