 ...
 * Use the [ResetPasswordInfoFragment.newInstance] factory method to
...
class ResetPasswordInfoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ResetPasswordInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResetPasswordInfoFragment().apply {
